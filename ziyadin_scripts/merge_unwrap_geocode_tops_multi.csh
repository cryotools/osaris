...
#
  ...
  # Read in parameters
  set config_file = $2
  set defomax =  `grep defomax $config_file| awk                     '$1 !~/#/ { if ($2 = "=") print $0}'| awk ' END { print $3}'`
  ...
  set region_cut =  `grep region_cut $config_file | awk              '$1 !~/#/ { if ($2 = "=") print $0}'| awk ' END { print $3}'` 
  set region_cut_geo =  `grep region_cut_geo $config_file | awk      '$1 !~/#/ { if ($2 = "=") print $0}'| awk ' END { print $3}'` 
  set switch_land =      `grep switch_land    $config_file | awk      '$1 !~/#/ { if ($2 = "=") print $0}'| awk ' END { print $3}'`
  ...
  if ( $#region_cut_geo == 1 )  then
   ...
   geo2radar.csh $region_cut_geo supermaster.PRM dem.grd
