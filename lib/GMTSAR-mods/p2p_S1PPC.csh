...
#
  if ($#argv < 4) then
    ...
    echo ""
    echo "Example: p2p_S1A_TOPS.csh S1A20150526_F1 S1A20150607_F1 config.tsx.slc.txt /home/user/"
    echo ""
...
#
      ...
      $osaris_path/lib/GMTSAR-mods/snaphu_S1PPC.csh $threshold_snaphu $defomax $region_cut
